...
public class VoitureTest {
    ...
    void testConstructor() {
        ...
        assertEquals("BMW", car.getMarque(), "Le constructeur n'a pas correctement initialisé la marque");
    }
    ...
    void testSetId() {
        ...
        assertEquals(2, car.getId(), "L'ID n'est pas mis à jour correctement");
    }

    @Test
    void testGetMarque() {
        assertEquals("Porsche", car.getMarque(), "getMarque retourne la bonne valeur");
        assertEquals("Toyota", car.getMarque(), "getMarque retourne une mauvaise valeur");
    }
    ...
    void testSetMarque() {
        ...
        assertEquals("Porsche", car.getMarque(), "setMarque n'a pas mis à jour la marque correctement");
    }

    @Test
    void testGetPrix() {
        assertEquals(9999999, car.getPrix(), "getPrix retourne le bon prix");
        assertEquals(1234, car.getPrix(), "getPrix retourne une mauvaise valeur");
    }
    ...
    void testSetPrix() {
        ...
        assertEquals(9999999, car.getPrix(), "setPrix n'a pas mis à jour correctement le prix");
    }
    ...
    void testToString() {
        ...
        assertEquals("Car{marque='BMW', prix=123456, id=1}", car.toString(), "toString retourne une chaîne incorrecte");
    }
    ...
    void testDefaultConstructor() {
        ...
        assertEquals(999, defaultCar.getId(), "L'ID par défaut est incorrect");
    }
    ...
    void testSetterAndGetterForId() {
        ...
        assertEquals(100, car.getId(), "Le getter pour l'ID retourne une mauvaise valeur");
    }
}
